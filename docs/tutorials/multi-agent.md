...
agent.kaos.dev/analyst           shared-model   true    Ready
agent.kaos.dev/coordinator       shared-model   true    Ready
agent.kaos.dev/researcher        shared-model   true    Ready
agent.kaos.dev/writer            shared-model   true    Ready

NAME                                     MODE     READY   PHASE
modelapi.kaos.dev/shared-model   Hosted   true    Ready
```
