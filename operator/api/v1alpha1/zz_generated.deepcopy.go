...
func (in *AgentConfig) DeepCopyInto(out *AgentConfig) {
	*out = *in
	if in.AgenticLoop != nil {
		in, out := &in.AgenticLoop, &out.AgenticLoop
		*out = new(AgenticLoopConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Env != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AgenticLoopConfig) DeepCopyInto(out *AgenticLoopConfig) {
	*out = *in
	if in.EnableTools != nil {
		in, out := &in.EnableTools, &out.EnableTools
		*out = new(bool)
		**out = **in
	}
	if in.EnableDelegation != nil {
		in, out := &in.EnableDelegation, &out.EnableDelegation
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AgenticLoopConfig.
func (in *AgenticLoopConfig) DeepCopy() *AgenticLoopConfig {
	if in == nil {
		return nil
	}
	out := new(AgenticLoopConfig)
