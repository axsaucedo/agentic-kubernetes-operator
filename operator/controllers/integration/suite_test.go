/*
Package integration contains integration tests for the controllers using envtest.
These tests verify end-to-end controller behavior with a real API server.
*/
package integration
